...
//
//////
#define iBuilder_saveToDisk		iBuilder_asciiWriteOutFile
#define iBuilder_readFromDisk	iBuilder_asciiReadFromFile
	...
	u8*			iBuilder_appendWhitespaces					(SBuilder* builder, s32 tnCount = 1, u8 cWhitespaceChar = 32);
	...
	u32			iBuilder_asciiWriteOutFile					(SBuilder* builder, cs8* tcPathname, bool tlAppend = false);
	u32			iBuilder_asciiWriteOutFile					(SBuilder* builder, cu8* tcPathname, bool tlAppend = false);
	bool		iBuilder_asciiReadFromFile					(SBuilder** builder, cs8* tcPathname);
