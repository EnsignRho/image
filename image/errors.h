...
//////
	...
	cu32			_ERROR_UNABLE_TO_OPEN_JOURNAL			= 50;
	cu32			_ERROR_INVALID_PARAMETER				= 51;
	...
	cu32			_ERROR_NO_ACTIVE_INDEX					= 110;
	cu32			_ERROR_NO_TABLE_IN_CURRENT_WORKAREA		= 111;
	cu32			_ERROR_FIELD_NOT_FOUND					= 112;
	cu32			_ERROR_DISK_SEEK_ERROR					= 113;
	cu32			_ERROR_DISK_CLOSE_ERROR					= 114;
	...
	cu32			_ERROR_INCOMPLETE_FEATURE				= 119;
	cu32			_ERROR_LAYOUT_COULD_NOT_BE_OPENED		= 120;
	cu32			_ERROR_UNABLE_TO_LOAD_LAYOUT			= 121;
	cu32			_ERROR_NAME_NOT_FOUND					= 122;
