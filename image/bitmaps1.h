...
//////
	...
	SBitmap*				iBmp_copyColorize						(SBitmap* bmpSrc, SBgra colorTemplate, f32 tfAlpha = 0.75f);
	...
	u32						iBmp_grayscale							(SBitmap* bmp, RECT* trc, f32 tfAlpha = 1.0f);
	...
	u32						iBmp_wavyLine							(SBitmap* bmp, RECT* trc, SBgra color, f32 tfAlpha = 1.0f);
...
// TODO:  The following void functions need to be changed to u32 and indicate how many pixels were rendered
	void					iBmp_drawPoint							(SBitmap* bmp, s32 tnX, s32 tnY, SBgra color, f32 tfAlpha = 1.0f);
	void					iBmp_drawBullet							(SBitmap* bmp, s32 tnX, s32 tnY, SBgra color, f32 tfAlpha = 1.0f);
